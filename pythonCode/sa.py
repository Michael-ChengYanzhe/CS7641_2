...
OUTFILE = '../outputData/XXX_LOG.csv'
...
def train(oa, network, oaName, training_ints, testing_ints, measure):
    ...
    with open(OUTFILE,'a+') as f:
        txt = '{},{},{},{},{},{}\n'.format(testing_time,testing_time,testing_time,testing_time,testing_time,testing_time);print txt
        f.write(txt)

def main(T, CE):
    """Run this experiment"""
    training_ints = initialize_instances('../mobile_price/traindata.csv')
    testing_ints = initialize_instances('../mobile_price/testdata.csv')
...
if __name__ == "__main__":
    for CE in [0.8,0.9,0.95,0.97,0.99]:
